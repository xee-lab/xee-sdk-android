...
[![Release 3.3.0](https://img.shields.io/badge/Version-3.3.0-green.svg)](https://github.com/xee-lab/xee-sdk-android/releases/tag/3.3.0)
...
```groovy
dependencies {
    compile 'com.github.xee-lab.xee-sdk-android:sdk-core:3.3.0'
    compile 'com.github.xee-lab.xee-sdk-android:sdk-api:3.3.0'
}
```
